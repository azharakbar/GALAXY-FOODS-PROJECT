	...
	app.post('/allItemsNew',isLoggedIn,function(req,res){
		...
		var pickUpNew = req.body.pickupDate
		var retNew = req.body.returnDate
	...
	/*		for ( var i = 0 ; i < items.length ; ++i ){
			...
			// Order.find( { $or : [ { returnDate : { $lt : x  } }  ]} , 'orderId items pickupDate returnDate -_id')
			// Order.find( { $or : [ { $and : [ { pickupDate : { $lt : pickUpNew } } , { returnDate : { $gt : retNew } } ] } , { $and : [ { pickupDate : { $gt : pickUpNew } } , { pickupDate : { $lt : retNew } } ] } , { $and : [ { returnDate : { $gt : pickUpNew } } , { returnDate : { $lt : retNew } } ] }  ]  } , 'orderId items pickupDate returnDate -_id'  )
			Order.find( { $or : [ { $and : [ { pickupDate : { $gt : pickUpNew } } , { returnDate : { $gt : retNew } } ] } , { $and : [ { pickupDate : { $lt : pickUpNew } } , { returnDate : { $lt : retNew } } ] } , { $and : [ { returnDate : { $gt : pickUpNew } } , { returnDate : { $lt : retNew } } ] }  ]  } , 'orderId items pickupDate returnDate -_id'  )
